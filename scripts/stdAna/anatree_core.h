...
// Mon Mar  7 14:16:52 2022 by ROOT version 6.22/08
// from TTree anatree/analysis tree
// found on file: jobs/data/dunetpc_v09_42_00_01/20000000/20000000/MUSUN_dunefdvd_1x8x6_20000000_gen_g4_detsim_cosmicpandora_reco_ana.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         trkId_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_tagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_tagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_tagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_containmenttagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_containmenttagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_containmenttagger_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_flashmatch_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_flashmatch_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_flashmatch_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkke_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkrange_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Int_t           trkidtruth_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Short_t         trkorigin_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Int_t           trkpdgtruth_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkefftruth_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpurtruth_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpitchc_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Short_t         ntrkhits_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkdedx_pmtrack[MAX_TRACKS][3][2000];   //[ntracks_pmtrack]
   Float_t         trkdqdx_pmtrack[MAX_TRACKS][3][2000];   //[ntracks_pmtrack]
   Float_t         trkresrg_pmtrack[MAX_TRACKS][3][2000];   //[ntracks_pmtrack]
   Int_t           trktpc_pmtrack[MAX_TRACKS][3][2000];   //[ntracks_pmtrack]
   Float_t         trkxyz_pmtrack[MAX_TRACKS][3][2000][3];   //[ntracks_pmtrack]
   Float_t         trkstartx_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstarty_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstartz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstartd_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkendx_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkendy_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkendz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkendd_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkflashT0_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trktrueT0_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Int_t           trkg4id_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Int_t           trkorig_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpurity_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkcompleteness_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trktheta_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkphi_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstartdcosx_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstartdcosy_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkstartdcosz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkenddcosx_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkenddcosy_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkenddcosz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkthetaxz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkthetayz_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkmom_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkmomrange_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkmommschi2_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkmommsllhd_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trklen_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trksvtxid_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkevtxid_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpidmvamu_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpidmvae_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpidmvapich_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpidmvaphoton_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Float_t         trkpidmvapr_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Int_t           trkpidpdg_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidchi_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipr_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidchika_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipi_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidchimu_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Float_t         trkpidpida_pmtrack[MAX_TRACKS][3];   //[ntracks_pmtrack]
   Short_t         trkpidbestplane_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkhasPFParticle_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         trkPFParticleID_pmtrack[MAX_TRACKS];   //[ntracks_pmtrack]
   Short_t         ntracks_pmtracktc;
   Short_t         trkId_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_tagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_tagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_tagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_containmenttagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_containmenttagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_containmenttagger_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_flashmatch_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_flashmatch_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_flashmatch_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkke_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkrange_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Int_t           trkidtruth_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Short_t         trkorigin_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Int_t           trkpdgtruth_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkefftruth_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpurtruth_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpitchc_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Short_t         ntrkhits_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkdedx_pmtracktc[MAX_TRACKS][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkdqdx_pmtracktc[MAX_TRACKS][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkresrg_pmtracktc[MAX_TRACKS][3][2000];   //[ntracks_pmtracktc]
   Int_t           trktpc_pmtracktc[MAX_TRACKS][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkxyz_pmtracktc[MAX_TRACKS][3][2000][3];   //[ntracks_pmtracktc]
   Float_t         trkstartx_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstarty_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstartz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstartd_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkendx_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkendy_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkendz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkendd_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkflashT0_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trktrueT0_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Int_t           trkg4id_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Int_t           trkorig_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpurity_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkcompleteness_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trktheta_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkphi_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosx_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosy_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkenddcosx_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkenddcosy_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkenddcosz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkthetaxz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkthetayz_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkmom_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkmomrange_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkmommschi2_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkmommsllhd_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trklen_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trksvtxid_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkevtxid_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpidmvamu_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpidmvae_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapich_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpidmvaphoton_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapr_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Int_t           trkpidpdg_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchi_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipr_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchika_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipi_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchimu_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Float_t         trkpidpida_pmtracktc[MAX_TRACKS][3];   //[ntracks_pmtracktc]
   Short_t         trkpidbestplane_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkhasPFParticle_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         trkPFParticleID_pmtracktc[MAX_TRACKS];   //[ntracks_pmtracktc]
   Short_t         ntracks_pandoraTrack;
   Short_t         trkId_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_tagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_tagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_tagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_flashmatch_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_flashmatch_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkke_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkrange_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Int_t           trkidtruth_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Short_t         trkorigin_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Int_t           trkpdgtruth_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkefftruth_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpurtruth_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpitchc_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Short_t         ntrkhits_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkdedx_pandoraTrack[28][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkdqdx_pandoraTrack[28][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkresrg_pandoraTrack[28][3][2000];   //[ntracks_pandoraTrack]
   Int_t           trktpc_pandoraTrack[28][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkxyz_pandoraTrack[28][3][2000][3];   //[ntracks_pandoraTrack]
   Float_t         trkstartx_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstarty_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstartz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstartd_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkendx_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkendy_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkendz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkendd_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkflashT0_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trktrueT0_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Int_t           trkg4id_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Int_t           trkorig_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpurity_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkcompleteness_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trktheta_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkphi_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosx_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosy_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosx_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosy_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkthetaxz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkthetayz_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkmom_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkmomrange_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkmommschi2_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkmommsllhd_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trklen_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trksvtxid_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkevtxid_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvamu_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvae_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapich_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvaphoton_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapr_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Int_t           trkpidpdg_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchi_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipr_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchika_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipi_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchimu_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidpida_pandoraTrack[28][3];   //[ntracks_pandoraTrack]
   Short_t         trkpidbestplane_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkhasPFParticle_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         trkPFParticleID_pandoraTrack[28];   //[ntracks_pandoraTrack]
   Short_t         ntracks_pmtrajfit;
   Short_t         trkId_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_tagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_tagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_tagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_containmenttagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_containmenttagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_containmenttagger_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_flashmatch_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_flashmatch_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_flashmatch_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkke_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkrange_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Int_t           trkidtruth_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Short_t         trkorigin_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Int_t           trkpdgtruth_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkefftruth_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpurtruth_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpitchc_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Short_t         ntrkhits_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkdedx_pmtrajfit[MAX_TRACKS][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkdqdx_pmtrajfit[MAX_TRACKS][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkresrg_pmtrajfit[MAX_TRACKS][3][2000];   //[ntracks_pmtrajfit]
   Int_t           trktpc_pmtrajfit[MAX_TRACKS][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkxyz_pmtrajfit[MAX_TRACKS][3][2000][3];   //[ntracks_pmtrajfit]
   Float_t         trkstartx_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstarty_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstartz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstartd_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkendx_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkendy_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkendz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkendd_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkflashT0_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trktrueT0_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Int_t           trkg4id_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Int_t           trkorig_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpurity_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkcompleteness_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trktheta_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkphi_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosx_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosy_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosx_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosy_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkthetaxz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkthetayz_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkmom_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkmomrange_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkmommschi2_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkmommsllhd_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trklen_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trksvtxid_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkevtxid_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvamu_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvae_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapich_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvaphoton_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapr_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Int_t           trkpidpdg_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchi_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipr_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchika_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipi_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchimu_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidpida_pmtrajfit[MAX_TRACKS][3];   //[ntracks_pmtrajfit]
   Short_t         trkpidbestplane_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkhasPFParticle_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   Short_t         trkPFParticleID_pmtrajfit[MAX_TRACKS];   //[ntracks_pmtrajfit]
   ...
   Short_t         vtxId_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
   Float_t         vtxx_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
   Float_t         vtxy_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
   Float_t         vtxz_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
   Short_t         vtxhasPFParticle_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
   Short_t         vtxPFParticleID_pmtrack[MAX_VERTICES];   //[nvtx_pmtrack]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("jobs/data/dunetpc_v09_42_00_01/20000000/20000000/MUSUN_dunefdvd_1x8x6_20000000_gen_g4_detsim_cosmicpandora_reco_ana.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("jobs/data/dunetpc_v09_42_00_01/20000000/20000000/MUSUN_dunefdvd_1x8x6_20000000_gen_g4_detsim_cosmicpandora_reco_ana.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("jobs/data/dunetpc_v09_42_00_01/20000000/20000000/MUSUN_dunefdvd_1x8x6_20000000_gen_g4_detsim_cosmicpandora_reco_ana.root:/analysistree");
