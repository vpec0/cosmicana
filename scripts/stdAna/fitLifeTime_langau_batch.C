...
void fitLifeTime_langau_batch(int batchno, int batchpart,
			      const char* outpref = "",
			      const char* dataversion = "v08_34_00")
{
    TString fname = Form("plots/%s/elifetime/batch_%d/batch_%d_part%d_anahists.root",
			 dataversion, batchno, batchno, batchpart);
    ...
    // fit results
    auto outf = TFile::Open(Form("%sfits.root", outpref), "update");
