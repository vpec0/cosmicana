...
// Wed Nov 13 19:52:30 2019 by ROOT version 6.18/04
// from TTree anatree/analysis tree
// found on file: data/MUSUN_dunefd_merged_gen_g4_detsim_reco_ana.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Short_t         hit_tpc[29049];   //[no_hits_stored]
   Short_t         hit_plane[29049];   //[no_hits_stored]
   Short_t         hit_wire[29049];   //[no_hits_stored]
   Short_t         hit_channel[29049];   //[no_hits_stored]
   Float_t         hit_peakT[29049];   //[no_hits_stored]
   Float_t         hit_charge[29049];   //[no_hits_stored]
   Float_t         hit_ph[29049];   //[no_hits_stored]
   Float_t         hit_startT[29049];   //[no_hits_stored]
   Float_t         hit_endT[29049];   //[no_hits_stored]
   Float_t         hit_rms[29049];   //[no_hits_stored]
   Float_t         hit_trueX[29049];   //[no_hits_stored]
   Float_t         hit_goodnessOfFit[29049];   //[no_hits_stored]
   Short_t         hit_multiplicity[29049];   //[no_hits_stored]
   Short_t         hit_trkid[29049];   //[no_hits_stored]
   Short_t         hit_trkKey[29049];   //[no_hits_stored]
   Short_t         hit_clusterid[29049];   //[no_hits_stored]
   Short_t         hit_clusterKey[29049];   //[no_hits_stored]
   Short_t         hit_spacepointid[29049];   //[no_hits_stored]
   Short_t         hit_spacepointKey[29049];   //[no_hits_stored]
   Float_t         hit_nelec[29049];   //[no_hits_stored]
   Float_t         hit_energy[29049];   //[no_hits_stored]
   Short_t         nnuvtx;
   ...
   Short_t         nclusters;
   Short_t         clusterId[1292];   //[nclusters]
   Short_t         clusterView[1292];   //[nclusters]
   Float_t         cluster_StartCharge[1292];   //[nclusters]
   Float_t         cluster_StartAngle[1292];   //[nclusters]
   Float_t         cluster_EndCharge[1292];   //[nclusters]
   Float_t         cluster_EndAngle[1292];   //[nclusters]
   Float_t         cluster_Integral[1292];   //[nclusters]
   Float_t         cluster_IntegralAverage[1292];   //[nclusters]
   Float_t         cluster_SummedADC[1292];   //[nclusters]
   Float_t         cluster_SummedADCaverage[1292];   //[nclusters]
   Float_t         cluster_MultipleHitDensity[1292];   //[nclusters]
   Float_t         cluster_Width[1292];   //[nclusters]
   Short_t         cluster_NHits[1292];   //[nclusters]
   Short_t         cluster_StartWire[1292];   //[nclusters]
   Short_t         cluster_StartTick[1292];   //[nclusters]
   Short_t         cluster_EndWire[1292];   //[nclusters]
   Short_t         cluster_EndTick[1292];   //[nclusters]
   Short_t         cluncosmictags_tagger[1292];   //[nclusters]
   Float_t         clucosmicscore_tagger[1292];   //[nclusters]
   Short_t         clucosmictype_tagger[1292];   //[nclusters]
   Char_t          kNTracker;
   ...
   Int_t           pdg[120539];   //[geant_list_size]
   Int_t           status[120539];   //[geant_list_size]
   Float_t         Mass[120539];   //[geant_list_size]
   Float_t         Eng[120539];   //[geant_list_size]
   Float_t         EndE[120539];   //[geant_list_size]
   Float_t         Px[120539];   //[geant_list_size]
   Float_t         Py[120539];   //[geant_list_size]
   Float_t         Pz[120539];   //[geant_list_size]
   Float_t         P[120539];   //[geant_list_size]
   Float_t         StartPointx[120539];   //[geant_list_size]
   Float_t         StartPointy[120539];   //[geant_list_size]
   Float_t         StartPointz[120539];   //[geant_list_size]
   Float_t         StartT[120539];   //[geant_list_size]
   Float_t         EndPointx[120539];   //[geant_list_size]
   Float_t         EndPointy[120539];   //[geant_list_size]
   Float_t         EndPointz[120539];   //[geant_list_size]
   Float_t         EndT[120539];   //[geant_list_size]
   Float_t         theta[120539];   //[geant_list_size]
   Float_t         phi[120539];   //[geant_list_size]
   Float_t         theta_xz[120539];   //[geant_list_size]
   Float_t         theta_yz[120539];   //[geant_list_size]
   Float_t         pathlen[120539];   //[geant_list_size]
   Int_t           inTPCActive[120539];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[120539];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[120539];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[120539];   //[geant_list_size]
   Float_t         StartT_tpcAV[120539];   //[geant_list_size]
   Float_t         StartE_tpcAV[120539];   //[geant_list_size]
   Float_t         StartP_tpcAV[120539];   //[geant_list_size]
   Float_t         StartPx_tpcAV[120539];   //[geant_list_size]
   Float_t         StartPy_tpcAV[120539];   //[geant_list_size]
   Float_t         StartPz_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[120539];   //[geant_list_size]
   Float_t         EndT_tpcAV[120539];   //[geant_list_size]
   Float_t         EndE_tpcAV[120539];   //[geant_list_size]
   Float_t         EndP_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPx_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPy_tpcAV[120539];   //[geant_list_size]
   Float_t         EndPz_tpcAV[120539];   //[geant_list_size]
   Float_t         pathlen_drifted[120539];   //[geant_list_size]
   Int_t           inTPCDrifted[120539];   //[geant_list_size]
   Float_t         StartPointx_drifted[120539];   //[geant_list_size]
   Float_t         StartPointy_drifted[120539];   //[geant_list_size]
   Float_t         StartPointz_drifted[120539];   //[geant_list_size]
   Float_t         StartT_drifted[120539];   //[geant_list_size]
   Float_t         StartE_drifted[120539];   //[geant_list_size]
   Float_t         StartP_drifted[120539];   //[geant_list_size]
   Float_t         StartPx_drifted[120539];   //[geant_list_size]
   Float_t         StartPy_drifted[120539];   //[geant_list_size]
   Float_t         StartPz_drifted[120539];   //[geant_list_size]
   Float_t         EndPointx_drifted[120539];   //[geant_list_size]
   Float_t         EndPointy_drifted[120539];   //[geant_list_size]
   Float_t         EndPointz_drifted[120539];   //[geant_list_size]
   Float_t         EndT_drifted[120539];   //[geant_list_size]
   Float_t         EndE_drifted[120539];   //[geant_list_size]
   Float_t         EndP_drifted[120539];   //[geant_list_size]
   Float_t         EndPx_drifted[120539];   //[geant_list_size]
   Float_t         EndPy_drifted[120539];   //[geant_list_size]
   Float_t         EndPz_drifted[120539];   //[geant_list_size]
   Int_t           NumberDaughters[120539];   //[geant_list_size]
   Int_t           Mother[120539];   //[geant_list_size]
   Int_t           TrackId[120539];   //[geant_list_size]
   Int_t           MergedId[120539];   //[geant_list_size]
   Int_t           origin[120539];   //[geant_list_size]
   Int_t           MCTruthIndex[120539];   //[geant_list_size]
   Int_t           process_primary[120539];   //[geant_list_size]
   vector<string>  *processname;
   Short_t         nshowers_emshower;
   Short_t         showerID_emshower[14];   //[nshowers_emshower]
   Short_t         shwr_bestplane_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_length_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_startdcosx_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_startdcosy_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_startdcosz_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_startx_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_starty_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_startz_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_totEng_emshower[14][3];   //[nshowers_emshower]
   Float_t         shwr_dedx_emshower[14][3];   //[nshowers_emshower]
   Float_t         shwr_mipEng_emshower[14][3];   //[nshowers_emshower]
   Short_t         shwr_hasPFParticle_emshower[14];   //[nshowers_emshower]
   Short_t         shwr_PFParticleID_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_pidmvamu_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_pidmvae_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_pidmvapich_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_pidmvaphoton_emshower[14];   //[nshowers_emshower]
   Float_t         shwr_pidmvapr_emshower[14];   //[nshowers_emshower]
   Short_t         ntracks_pmtrack;
   Short_t         trkId_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_tagger_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_tagger_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_tagger_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_containmenttagger_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_containmenttagger_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_containmenttagger_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkncosmictags_flashmatch_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkcosmicscore_flashmatch_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkcosmictype_flashmatch_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkke_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkrange_pmtrack[336][3];   //[ntracks_pmtrack]
   Int_t           trkidtruth_pmtrack[336][3];   //[ntracks_pmtrack]
   Short_t         trkorigin_pmtrack[336][3];   //[ntracks_pmtrack]
   Int_t           trkpdgtruth_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkefftruth_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpurtruth_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpitchc_pmtrack[336][3];   //[ntracks_pmtrack]
   Short_t         ntrkhits_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkdedx_pmtrack[336][3][2000];   //[ntracks_pmtrack]
   Float_t         trkdqdx_pmtrack[336][3][2000];   //[ntracks_pmtrack]
   Float_t         trkresrg_pmtrack[336][3][2000];   //[ntracks_pmtrack]
   Int_t           trktpc_pmtrack[336][3][2000];   //[ntracks_pmtrack]
   Float_t         trkxyz_pmtrack[336][3][2000][3];   //[ntracks_pmtrack]
   Float_t         trkstartx_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstarty_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstartz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstartd_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkendx_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkendy_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkendz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkendd_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkflashT0_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trktrueT0_pmtrack[336];   //[ntracks_pmtrack]
   Int_t           trkg4id_pmtrack[336];   //[ntracks_pmtrack]
   Int_t           trkorig_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpurity_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkcompleteness_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trktheta_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkphi_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstartdcosx_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstartdcosy_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkstartdcosz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkenddcosx_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkenddcosy_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkenddcosz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkthetaxz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkthetayz_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkmom_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkmomrange_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkmommschi2_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkmommsllhd_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trklen_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trksvtxid_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkevtxid_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpidmvamu_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpidmvae_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpidmvapich_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpidmvaphoton_pmtrack[336];   //[ntracks_pmtrack]
   Float_t         trkpidmvapr_pmtrack[336];   //[ntracks_pmtrack]
   Int_t           trkpidpdg_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidchi_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipr_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidchika_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidchipi_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidchimu_pmtrack[336][3];   //[ntracks_pmtrack]
   Float_t         trkpidpida_pmtrack[336][3];   //[ntracks_pmtrack]
   Short_t         trkpidbestplane_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkhasPFParticle_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         trkPFParticleID_pmtrack[336];   //[ntracks_pmtrack]
   Short_t         ntracks_pmtracktc;
   Short_t         trkId_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_tagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_tagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_tagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_containmenttagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_containmenttagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_containmenttagger_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkncosmictags_flashmatch_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkcosmicscore_flashmatch_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkcosmictype_flashmatch_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkke_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkrange_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Int_t           trkidtruth_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Short_t         trkorigin_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Int_t           trkpdgtruth_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkefftruth_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpurtruth_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpitchc_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Short_t         ntrkhits_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkdedx_pmtracktc[347][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkdqdx_pmtracktc[347][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkresrg_pmtracktc[347][3][2000];   //[ntracks_pmtracktc]
   Int_t           trktpc_pmtracktc[347][3][2000];   //[ntracks_pmtracktc]
   Float_t         trkxyz_pmtracktc[347][3][2000][3];   //[ntracks_pmtracktc]
   Float_t         trkstartx_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstarty_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstartz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstartd_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkendx_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkendy_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkendz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkendd_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkflashT0_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trktrueT0_pmtracktc[347];   //[ntracks_pmtracktc]
   Int_t           trkg4id_pmtracktc[347];   //[ntracks_pmtracktc]
   Int_t           trkorig_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpurity_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkcompleteness_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trktheta_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkphi_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosx_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosy_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkstartdcosz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkenddcosx_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkenddcosy_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkenddcosz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkthetaxz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkthetayz_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkmom_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkmomrange_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkmommschi2_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkmommsllhd_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trklen_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trksvtxid_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkevtxid_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpidmvamu_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpidmvae_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapich_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpidmvaphoton_pmtracktc[347];   //[ntracks_pmtracktc]
   Float_t         trkpidmvapr_pmtracktc[347];   //[ntracks_pmtracktc]
   Int_t           trkpidpdg_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchi_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipr_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchika_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchipi_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidchimu_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Float_t         trkpidpida_pmtracktc[347][3];   //[ntracks_pmtracktc]
   Short_t         trkpidbestplane_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkhasPFParticle_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         trkPFParticleID_pmtracktc[347];   //[ntracks_pmtracktc]
   Short_t         ntracks_pandoraTrack;
   Short_t         trkId_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_tagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_tagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_tagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_containmenttagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_containmenttagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_containmenttagger_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkncosmictags_flashmatch_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkcosmicscore_flashmatch_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkcosmictype_flashmatch_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkke_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkrange_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Int_t           trkidtruth_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Short_t         trkorigin_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Int_t           trkpdgtruth_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkefftruth_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpurtruth_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpitchc_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Short_t         ntrkhits_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkdedx_pandoraTrack[11][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkdqdx_pandoraTrack[11][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkresrg_pandoraTrack[11][3][2000];   //[ntracks_pandoraTrack]
   Int_t           trktpc_pandoraTrack[11][3][2000];   //[ntracks_pandoraTrack]
   Float_t         trkxyz_pandoraTrack[11][3][2000][3];   //[ntracks_pandoraTrack]
   Float_t         trkstartx_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstarty_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstartz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstartd_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkendx_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkendy_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkendz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkendd_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkflashT0_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trktrueT0_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Int_t           trkg4id_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Int_t           trkorig_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpurity_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkcompleteness_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trktheta_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkphi_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosx_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosy_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkstartdcosz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosx_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosy_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkenddcosz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkthetaxz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkthetayz_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkmom_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkmomrange_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkmommschi2_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkmommsllhd_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trklen_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trksvtxid_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkevtxid_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvamu_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvae_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapich_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvaphoton_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Float_t         trkpidmvapr_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Int_t           trkpidpdg_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchi_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipr_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchika_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchipi_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidchimu_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Float_t         trkpidpida_pandoraTrack[11][3];   //[ntracks_pandoraTrack]
   Short_t         trkpidbestplane_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkhasPFParticle_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         trkPFParticleID_pandoraTrack[11];   //[ntracks_pandoraTrack]
   Short_t         ntracks_pmtrajfit;
   Short_t         trkId_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_tagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_tagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_tagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_containmenttagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_containmenttagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_containmenttagger_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkncosmictags_flashmatch_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkcosmicscore_flashmatch_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkcosmictype_flashmatch_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkke_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkrange_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Int_t           trkidtruth_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Short_t         trkorigin_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Int_t           trkpdgtruth_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkefftruth_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpurtruth_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpitchc_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Short_t         ntrkhits_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkdedx_pmtrajfit[28][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkdqdx_pmtrajfit[28][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkresrg_pmtrajfit[28][3][2000];   //[ntracks_pmtrajfit]
   Int_t           trktpc_pmtrajfit[28][3][2000];   //[ntracks_pmtrajfit]
   Float_t         trkxyz_pmtrajfit[28][3][2000][3];   //[ntracks_pmtrajfit]
   Float_t         trkstartx_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstarty_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstartz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstartd_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkendx_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkendy_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkendz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkendd_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkflashT0_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trktrueT0_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Int_t           trkg4id_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Int_t           trkorig_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpurity_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkcompleteness_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trktheta_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkphi_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosx_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosy_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkstartdcosz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosx_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosy_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkenddcosz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkthetaxz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkthetayz_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkmom_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkmomrange_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkmommschi2_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkmommsllhd_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trklen_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trksvtxid_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkevtxid_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvamu_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvae_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapich_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvaphoton_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Float_t         trkpidmvapr_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Int_t           trkpidpdg_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchi_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipr_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchika_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchipi_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidchimu_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Float_t         trkpidpida_pmtrajfit[28][3];   //[ntracks_pmtrajfit]
   Short_t         trkpidbestplane_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkhasPFParticle_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         trkPFParticleID_pmtrajfit[28];   //[ntracks_pmtrajfit]
   Short_t         nvtx_linecluster;
   Short_t         vtxId_linecluster[6];   //[nvtx_linecluster]
   Float_t         vtxx_linecluster[6];   //[nvtx_linecluster]
   Float_t         vtxy_linecluster[6];   //[nvtx_linecluster]
   Float_t         vtxz_linecluster[6];   //[nvtx_linecluster]
   Short_t         vtxhasPFParticle_linecluster[6];   //[nvtx_linecluster]
   Short_t         vtxPFParticleID_linecluster[6];   //[nvtx_linecluster]
   Short_t         nvtx_pmtrack;
   Short_t         vtxId_pmtrack[295];   //[nvtx_pmtrack]
   Float_t         vtxx_pmtrack[295];   //[nvtx_pmtrack]
   Float_t         vtxy_pmtrack[295];   //[nvtx_pmtrack]
   Float_t         vtxz_pmtrack[295];   //[nvtx_pmtrack]
   Short_t         vtxhasPFParticle_pmtrack[295];   //[nvtx_pmtrack]
   Short_t         vtxPFParticleID_pmtrack[295];   //[nvtx_pmtrack]
   Short_t         nvtx_pandora;
   Short_t         vtxId_pandora[20];   //[nvtx_pandora]
   Float_t         vtxx_pandora[20];   //[nvtx_pandora]
   Float_t         vtxy_pandora[20];   //[nvtx_pandora]
   Float_t         vtxz_pandora[20];   //[nvtx_pandora]
   Short_t         vtxhasPFParticle_pandora[20];   //[nvtx_pandora]
   Short_t         vtxPFParticleID_pandora[20];   //[nvtx_pandora]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data/MUSUN_dunefd_merged_gen_g4_detsim_reco_ana.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data/MUSUN_dunefd_merged_gen_g4_detsim_reco_ana.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("data/MUSUN_dunefd_merged_gen_g4_detsim_reco_ana.root:/analysistree");
